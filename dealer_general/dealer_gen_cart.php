...
if (isset($_POST['submit_order'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($stmt) {
            ...
            header("refresh:0.0000000001; url=dealer_gen_order?product=$product&qty=$aaa");
        } else {
...
if (isset($_POST['delete'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($sql) {
            ...
            header("refresh:2; url=dealer_gen_cart");
        } else {
            echo "<script>alert('มีบางอย่างผิดพลาด');</script>";
            header("refresh:0.0000000001; url=dealer_gen_cart");
        }
...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <div class="bg-box-cart">
        ...
        <div class="box-cart">
            ...
            <form action="../dealer_general/dealer_gen_cart" class="box-bg-cart" method="post">
                    ...
                    if ($sql_p->rowCount() > 0) { ?>
                        <?php foreach ($row_p as $row_p) { ?>
                            <div class="bg-content-cart">
                                ...
                                <div class="box-img-cart"><img src="../admin/p_img/<?= $row_p['p_img1'] ?>" width="100%" alt=""></div>
    ...
    <div class="recommence-product">
        ...
        <div class=" box-rec-pd">
            ...
            ?>
                    <div class="rec-pd">
                        <a class="a-none" href="../dealer_general/dealer_gen_product_detail?p_id=<?= $product['p_id']; ?>">
                            <div class="card" id="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="../dealer_general/dealer_gen_product_detail?p_id=<?= $product['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="btn-see-more">
                <a href="../dealer_general/dealer_gen_product"><button type="button" class="btn" id="see-more">ดูเพิ่มเติม</button></a>
            </div>
