...
if (isset($_GET['act'])) {
    $name = $_GET['search'];
    $s =  urlencode($name);
    header("refresh:0.0000000001; url=dealer_gen_product?search=$s");
}
...
<body style="font-family: 'Kanit', sans-serif ;">
            ...
            <div class="col-lg-12 m-auto" style="height: auto;">
                ...
                <div class="carousel slide" id="slider1" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../asset/img/carousel-dealer4.gif" class="d-block m-auto  carousel-img-user">
    ...
    <div class="user-catagorie">
        <div class="item-catagorie" >
            ...
            <div class="user-cat-box">
                <div class="bg-item">
                    <div class="item">
                        <a href="../dealer_general/dealer_gen_product?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer_general/dealer_gen_product?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
        ...
        <!-- <div class="cata-med">
            <div class="bg-cat-med">
                ...
                <?php foreach ($p_type as $p_type) { ?>
                    <a href="../dealer_general/dealer_gen_product?t_id=<?= $p_type['t_id']; ?>&name=<?= $p_type['t_name'] ?>" style="text-decoration: none; width: 90%; color: #000000;">
        ...
        <div class="pd">
            ...
            foreach ($result as $result) { ?>
                <div class="content-pd">
                    <a class="a-none" href="../dealer_general/dealer_gen_product_detail?p_id=<?= $result['p_id']; ?>">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../dealer_general/dealer_gen_product_detail?p_id=<?= $result['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="ads">
        ...
        <!-- <img src="../asset/img/ads1.png" width="45%" alt=""> -->
    </div>
