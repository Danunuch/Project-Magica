        ...
        <div class="p-bg-menu" style="padding-left: 0px; padding-right: 0px;">
            ...
            <img class="p-profile-icon" src="../asset/upload/profile_user/<?php if ($row['m_img'] == null) {echo "profile-icon.png";
                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        ...
                        <div class="collapse show" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small sidebar-flip">
                                <li><a href="../dealer_general/dealer_gen_profile" id="p-list-menu">
                                        <p id="p-list-menu">ข้อมูลของฉัน</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_bank" id="p-list-menu"> 
                                        <p id="p-list-menu">บัญชีธนาคาร</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_password" id="p-list-menu">
                                        <p id="p-list-menu">เปลี่ยนรหัสผ่าน</p>
                                    </a></li>
                                <li ><a href="../dealer_general/dealer_gen_profile_address" id="p-list-menu">
                    ...
                    <li class="mb-1">
                       <a href="../dealer_general/dealer_gen_my_purchase"><button class="btn btn-toggle" id="p-btn-color" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                            การซื้อของฉัน
                        </button></a>
