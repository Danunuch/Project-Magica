...
if (isset($_SESSION['dealer_general_login'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM dealer_general WHERE id = $user_id");
    $stmt->execute();
...
if (isset($_POST['update'])) {
    ...
    $sql = $conn->prepare("UPDATE dealer_general SET firstname = :firstname, lastname = :lastname, email = :email, tel = :tel, line_Id = :line_Id, Id_card = :Id_card WHERE id = :id");
    $sql->bindParam(":id", $id);
    ...
    if ($sql) {
        ...
        echo "<meta http-equiv='Refresh' content='0.001; url=dealer_gen_profile'>";
        // header("refresh:0.0000000001; url=dealer_gen_profile");
    }
}
            ...
            <div class="form-group">
                ...
                <div class="content-form">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="tel" value="<?php echo $row['Id_card']; ?>" class="form-control fo-1" maxlength="13" name="Id_card">
                    </div>
                </div>
                <!-- <div class="content-form">
                    <div class="one">
                    ...
                    <div class="two">
                        ...
                        <div class="mm">
                            ...
                            <input type="tel" value="<?php echo $row['tel']; ?>" class="form-control" name="tel" maxlength="10" aria-describedby="tel">
                        </div>
                        <div class="mm">
                            <label for="Id_card" class="form-label" style="margin-bottom: 0px;">เลขบัตรประจำตัวประชาชน</label>
                            <input type="tel" value="<?php echo $row['Id_card']; ?>" class="form-control" maxlength="13" name="Id_card">
                        </div>
                    </div>
                </div> -->
