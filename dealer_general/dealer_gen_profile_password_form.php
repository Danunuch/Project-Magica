...
if (isset($_POST['submit_password'])) {
    ...
    if (empty($old_password)) {
        ...
        header("location: dealer_gen_profile_password");
        ...
        try {
            $check_password = $conn->prepare("SELECT password FROM dealer_general WHERE id = :id");
            ...
            if (!isset($_SESSION['error_pass'])) {
                if (password_verify($old_password, $row['password'])) {
                    ...
                    $sql = $conn->prepare("UPDATE dealer_general SET password = :password WHERE id = :id");
                     $sql->bindParam(":id", $id);
                    ...
                    if ($sql) {
                        ...
                        header("refresh:0.0000000001; url=dealer_gen_profile_password");
                    }
                } else {
...
<div class="p-form-box">
    ...
    <div class="content">
        <form action="dealer_gen_profile_password_form" method="post">
