...
if (isset($_GET['p_id'])) {
    ...
    if ($stmtPD_D->rowCount() != 1) {
        header('location: ../dealer_general/dealer_gen_product');
        exit();
    }
}
...
if (isset($_POST['add-to-card'])) {
    ...
    if (!empty($qty) && !empty($p_id)) {
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    header("refresh:2; url=dealer_gen_product_detail?p_id=$p_id");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    header("refresh:0.0000000001; url=dealer_gen_product_detail?p_id=$p_id");
                }
            }
        } else {
            $sql = $conn->prepare("INSERT INTO cart(qty,price,product_id, user_id, status_cart)
        ...
        // header("refresh:3; url=dealer_gen_product_detail?p_id=$p_id");
    }
}
        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    // })
                    // </script>";
                    header("refresh:0.0000001; url=dealer_gen_cart");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    // </script>";
                    $check_state = true;
                    header("refresh:1; url=dealer_gen_cart");
                } else {
                    echo "<script>alert('มีบางอย่างผิดพลาด')</script>";
                    header("refresh:0.0000000001; url=dealer_gen_cart");
                }
            }
        } else {
            $sql = $conn->prepare("INSERT INTO cart(qty,price,product_id, user_id, status_cart)
            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                ...
                <ul class="navbar-links">
                    <div class="line-bottom">
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="../dealer_general/dealer_gen_product">สินค้า</a>
                        </li>
                        <div class="line-center"></div>
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="#">โปรโมชั่น</a></li>
                        <div class="line-center"></div>
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="about">เกี่ยวกับเรา</a></li>
                        <a class="dropdown-item " href="../dealer_general/dealer_gen_cart"><button class="btn-register">รถเข็นสินค้า</button></a>
                        <a class="dropdown-item " href="../dealer_general/dealer_gen_profile"><button class="btn-register">ข้อมูลของฉัน</button></a>
                        <a class="dropdown-item" href="../dealer_general/dealer_gen_profile_bank"><button class="btn-register">บัญชีธนาคาร</button></a>
                        <a class="dropdown-item" href="../dealer_general/dealer_gen_profile_password"><button class="btn-register">เปลี่ยนรหัสผ่าน</button></a>
                        <a class="dropdown-item" href="../dealer_general/dealer_gen_profile_address"><button class="btn-register">ที่อยู่</button></a>
                        <a class="dropdown-item" href="../dealer_general/dealer_gen_my_purchase"><button class="btn-register">การซื้อของฉัน</button></a>
                        <a class="dropdown-item" href="../logout"><button class="btn-register"><i class="bi bi-person-plus-fill"></i>ออกจากระบบ</button></a>
                    </div>
                    <div class="btnn-profile">
                        <div class="cart-icon"> <a href="../dealer_general/dealer_gen_cart"><i class="bi bi-cart3"></i></a></div>
                        ...
                        <div class="profile-icon">
                            <div class="dropdown"><button type="button" id="icon-profile" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-circle" id="icon-login-profile"></i></button>
                                <ul class="dropdown-menu dropdown-menu-profile">
                                    ...
                                    <li><a class="dropdown-item " href="../dealer_general/dealer_gen_profile"><i class="bi bi-person-circle" id="icon-login-profile-drop"></i>บัญชีของฉัน</a></li>
                                    <li><a class="dropdown-item" href="../dealer_general/dealer_gen_my_purchase"><i class="bi bi-journal-text"></i>การซื้อของฉัน</a></li>
                                    <li><a class="dropdown-item" href="../logout"><i class="bi bi-box-arrow-right"></i>ออกจากระบบ</a></li>
                                    <li>
                ...
                <div class="pur-bill ">
                    ...
                    <div class="a-1" id="a-2">
                        <div class="dealer-radio-buttons-list">
                            <div  <?php if($rowPD_D['p_price1']=="0"){echo 'class="none"';}else{echo 'class="radio1"';} ?>>
                                <label class="radio dealer-radio">
                                    <input class="radio__input" id="amount-one" type="radio" value="50/<?=$rowPD_D['p_price1'] ?>" name="quantity" checked>
                                    <span class="radio__span" id="am-1">50 <?= $rowPD_D["p_unit"] ?></span>
                                </label>
                            </div>
                            <div  <?php if($rowPD_D['p_price2']=="0"){echo 'class="none"';}else{echo 'class="radio2"';} ?>>
                                <label class="radio dealer-radio">
                                    <input class="radio__input" id="amount-two" type="radio" value="100/<?=$rowPD_D['p_price2'] ?>" name="quantity">
                                    <span class="radio__span" id="am-2">100 <?= $rowPD_D["p_unit"] ?></span>
                                </label>
                            </div>
                            <div <?php if($rowPD_D['p_price3']=="0"){echo 'class="none"';}else{echo 'class="radio3"';} ?>>
                                <label class="radio dealer-radio">
                                    <input class="radio__input" id="amount-three" type="radio" value="300/<?=$rowPD_D['p_price3'] ?>" name="quantity">
                                    <span class="radio__span" id="am-3">300 <?= $rowPD_D["p_unit"] ?></span>
                                </label>
                            </div>
                            <div  <?php if($rowPD_D['p_price4']=="0"){echo 'class="none"';}else{echo 'class="radio4"';} ?>>
                                <label class="radio dealer-radio">
                                    <input class="radio__input" id="amount-four" type="radio" value="500/<?=$rowPD_D['p_price4'] ?>" name="quantity">
                                    <span class="radio__span" id="am-4">500 <?= $rowPD_D["p_unit"] ?></span>
                                </label>
                            </div>
                            <div  <?php if($rowPD_D['p_price5']=="0"){echo 'class="none"';}else{echo 'class="radio5"';} ?>>
                                <label class="radio dealer-radio">
                                    <input class="radio__input" id="amount-five" type="radio" value="1000/<?=$rowPD_D['p_price5'] ?>" name="quantity">
            ...
            <div class="g-box-related">
                ...
                foreach ($rowRT as $rowRT) { ?>
                    <div class="related-RT">
                        <a class="a-none" href="../dealer_general/dealer_gen_product_detail?p_id=<?= $rowRT['p_id']; ?>">
                            <div class="card" id="card">
                                <div class="card-top">
                                    <img src="../admin/p_img/<?= $rowRT['p_img1'] ?>" class="card-img-top" alt="...">
                                </div>
                                <div class="card-body">
                                    <p class="card-title"><?= $rowRT['p_name'] ?></p>
                                    <p class="card-text">฿<?= number_format($rowRT['p_price1'], 2) ?></p>
                                    <a href="../dealer_general/dealer_gen_product_detail?p_id=<?= $rowRT['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                                </div>
                            </div>
                        </a>
                    </div>
