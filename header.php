            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                ...
                <ul class="navbar-links">
                    <div class="line-bottom">
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="product">สินค้า</a>
                        </li>
                    ...
                    <div class="btnn">
                        <button class="btn-login" id="btn-login" onclick="window.location.href='signin'" ><i class="bi bi-person-circle"></i>เข้าสู่ระบบ</button>
                    </div>
                </ul>
