...
<head>
    ...
    <title>Profile Bank - MAGICA</title>
...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <header class="container-fluid" id="navbar">
        <nav class="navbar-container container-fluid">
            <a href="/magica/user/home.php" class="home-link">
            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                ...
                <ul class="navbar-links">
                    <div class="line-bottom">
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="../user/product.php">สินค้า</a>
                        </li>
                        ...
                        <a class="dropdown-item " href="../user/cart.php"><button class="btn-register">รถเข็นสินค้า</button></a>
                        <a class="dropdown-item " href="../user/profile.php"><button class="btn-register">ข้อมูลของฉัน</button></a>
                        <a class="dropdown-item" href="../user/profile_bank.php"><button class="btn-register">บัญชีธนาคาร</button></a>
                        <a class="dropdown-item" href="../user/profile_password.php"><button class="btn-register">เปลี่ยนรหัสผ่าน</button></a>
                        <a class="dropdown-item" href="../user/profile_address.php"><button class="btn-register">ที่อยู่</button></a>
                        <a class="dropdown-item" href="../user/my_purchase.php"><button class="btn-register">การซื้อของฉัน</button></a>
                    ...
                    <div class="cart-icon"> <a href="../user/cart.php"><i class="bi bi-cart3"></i></a></div>
                        ...
                        <div class="profile-icon">
                            ...
                            <img src="../admin/m_img/<?php if ($row['m_img'] == null) {
                                ...
                                <ul class="dropdown-menu dropdown-menu-profile">
                                    ...
                                    <li><a class="dropdown-item " href="../user/profile.php"><i class="bi bi-person-circle" id="icon-login-profile-drop"></i>บัญชีของฉัน</a></li>
                                    <li><a class="dropdown-item" href="../user/my_purchase.php"><i class="bi bi-journal-text"></i>การซื้อของฉัน</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-9 sh" style="padding-left: 0px; padding-right: 0px;">
                <?php include('../user/profile_bank_form.php') ?>
            </div>
        </div>
    </div>
