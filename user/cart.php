...
if (isset($_GET['act'])) {
    $name = $_GET['search'];
    $s =  urlencode($name);
    header("refresh:0.0000000001; url=product?search=$s");
}
...
if (isset($_POST['submit_order'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($stmt) {
            ...
            header("refresh:0.0000000001; url=order?product=$product&qty=$aaa");
        } else {
            //   echo "<script>alert('มีบางอย่างผิดพลาด');</script>";
            header("refresh:0.0000000001; url=cart");
        }
    } else {
...
<body style="font-family: 'Kanit', sans-serif ;">
                ...
                <ul class="navbar-links">
                    ...
                    <div class="cart-icon"> <a href="../user/cart"><i class="bi bi-cart3"></i></a></div>
                        ...
                        <div class="profile-icon">
                            ...
                            <img src="../admin/m_img/<?php if ($row['m_img'] == null) {echo "icon-profile.png";
                                                            } else {
                                                                echo $row['m_img'];
                                                            }
    ...
    <div class="bg-box-cart">
        ...
        <div class="box-cart">
            ...
            <form action="../user/cart" class="box-bg-cart" method="post">
                ...
                foreach ($rowCart as $rowCart) { ?>
                    ...
                    $sql_p = $conn->prepare("SELECT * FROM product WHERE p_id = $p_id ");
                    $sql_p->execute();
                        ...
                        <?php foreach ($row_p as $row_p) { ?>
                            <div class="bg-content-cart">
                                ...
                                <div class="box-txt-cart">
                                    ...
                                    <p><?= '฿' . number_format($row_p['p_price'], 2) ?></p>
                                    <div class="number-input">
                                        <input type="button" onclick="this.parentNode.querySelector('input[type=number]').stepDown()" class="plus" value="-">
                                        <input class="quantity" min="1" name="quantity[]" value="<?php echo $rowCart['qty'] ?>" type="number">
    ...
    <div class="recommence-product">
        ...
        <div class=" box-rec-pd">
                    ...
                    <div class="rec-pd">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../user/product_detail?p_id=<?= $product['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="btn-see-more">
                <a href="../user/product"><button type="button" class="btn" id="see-more">ดูเพิ่มเติม</button></a>
            </div>
