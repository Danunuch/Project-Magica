...
if (isset($_GET['product'])) {
    ...
    for ($i = 0; $i < count($p_id); $i++) {
        $sql = $conn->prepare("SELECT * FROM product WHERE p_id = ($p_id[$i])");
   ...
   // $shipping_name = $_POST["shipping_name"];
            ...
            if ($slip_img['size'] > 0 && $slip_img['error'] == 0) {
                if (move_uploaded_file($slip_img['tmp_name'], $filePath1)) {
                    ...
                    for ($i = 0; $i < count($qty2); $i++) {
                        $p_price[] = $final_p[$i][0]["p_price"] * $product[$i][1];
    ...
    if ($payment_method == 3) {
        ...
        if ($order_detail) {
            ...
            $sMessage .= "คุณ " . $p_name . " " . "ได้ทำการสั่งซื้อสินค้า\r\n";
            $sMessage .= "หมายเลขคำสั่งซื้อเลขที่: " . $id_order .  " \r\n";
            $sMessage .= "ราคาทั้งหมด: " . "฿" . number_format($last_price, 2)  . " \r\n";
            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                ...
                <ul class="navbar-links">
                    <div class="line-bottom">
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="../user/product">สินค้า</a>
                        </li>
                        ...
                        <a class="dropdown-item " href="../user/cart"><button class="btn-register">รถเข็นสินค้า</button></a>
                        <a class="dropdown-item " href="../user/profile"><button class="btn-register">ข้อมูลของฉัน</button></a>
                        <a class="dropdown-item" href="../user/profile_bank"><button class="btn-register">บัญชีธนาคาร</button></a>
                        <a class="dropdown-item" href="../user/profile_password"><button class="btn-register">เปลี่ยนรหัสผ่าน</button></a>
                        <a class="dropdown-item" href="../user/profile_address"><button class="btn-register">ที่อยู่</button></a>
                        <a class="dropdown-item" href="../user/my_purchase"><button class="btn-register">การซื้อของฉัน</button></a>
                    ...
                    <div class="btnn-profile">
                        <div class="cart-icon"> <a href="../user/cart"><i class="bi bi-cart3"></i></a></div>
                        <div class="line-center-profile"></div>
                        <div class="profile-icon">
                            <div class="dropdown"><button type="button" id="icon-profile" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu dropdown-menu-profile">
                                    ...
                                    <li><a class="dropdown-item " href="../user/profile"><i class="bi bi-person-circle" id="icon-login-profile-drop"></i>บัญชีของฉัน</a></li>
                                    <li><a class="dropdown-item" href="../user/my_purchase"><i class="bi bi-journal-text"></i>การซื้อของฉัน</a></li>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="order-address-box">
                ...
                <div class="order-box-input-address">
                    ...
                    <a href="../user/profile_address"><button type="button" class="order-btn-address-submit">เปลี่ยน</button></a>
                    ...
                    <table class="table table-hover table-order-style">
                        ...
                        for ($i = 0; $i < count($product); $i++) {  ?>
                            ...
                            <tbody class="align-middle">
                                <tr>
                                    <th>
                                        <img class="img-list-order" src="../admin/p_img/<?= $final_p[$i][0][6] ?>" alt="">
                                    </th>
                                    <td><?= $final_p[$i][0]["p_name"] ?></td>
                                    <td>฿<?= number_format($final_p[$i][0][3], 2)  ?></td>
                                    <td><?= $product[$i][1] ?></td>
                                    <td>฿<?= number_format($final_p[$i][0][3] * $product[$i][1], 2)  ?></td>
                                </tr>
                            </tbody>
