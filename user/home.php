...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <div class="user-catagorie">
        <div class=" item-catagorie">
            ...
            <div class="user-cat-box">
                <div class="bg-item">
                    <div class="item">
                        <a href="../user/product?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
                ...
                <div class="bg-item">
                    <div class="item">
                        <a href="../user/product?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
    ...
    <div class="recommence-product">
        <div class="text-rec"><span class="cat-txt-title1">แนะนำสำหรับคุณ</span></div>
        <div class="box-rec-pd">
            ...
            ?>
                    <div class="rec-pd">
                        <a class="a-none" href="../user/product_detail?p_id=<?= $product['p_id']; ?>">
