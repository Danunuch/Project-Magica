        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    header("refresh:2; url=product_detail?p_id=$p_id");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    header("refresh:0.0000000001; url=product_detail?p_id=$p_id");
                }
            }
        } else {
            $sql = $conn->prepare("INSERT INTO cart(qty, product_id, user_id, status_cart)
        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    // })
                    // </script>";
                    header("refresh:0.00001; url=cart");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    // </script>";
                    $check_state = true;
                    header("refresh:0.0000001; url=cart");
                } else {
                    ...
                    <div class="related-RT">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="../user/product_detail?p_id=<?= $rowRT['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                <?php
