...
if (isset($_POST['submit'])) {
    ...
    if (empty($addressed)) {
        ...
        header("refresh:0.0000000000001; url=dealer_profile_address");
    } else if (empty($provinces)) {
        echo "<script>alert('กรุณากรอกข้อมูลให้ครบถ้วน')</script>";
        header("refresh:0.0000000000001; url=dealer_profile_address");
    } else if (empty($amphures)) {
        echo "<script>alert('กรุณากรอกข้อมูลให้ครบถ้วน')</script>";
        header("refresh:0.0000000001; url=dealer_profile_address");
            ...
            if (!isset($_SESSION['error'])) {
                ...
                if ($sql) {
                    // echo "<script>alert('แก้ไขข้อมูลเสร็จสิ้น')</script>";
                     echo "<meta http-equiv='Refresh' content='0.001; url=dealer_profile_address'>";
