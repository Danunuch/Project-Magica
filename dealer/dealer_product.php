...
<body style="font-family: 'Kanit', sans-serif ;">
    ...
    <div class="pd-content">
        <div class="pd">
            ...
            <?php  }
            if($result == null){
                echo "<h5 style='margin:20px auto; text-align:center;'>ยังไม่มีสินค้า</h5>";
            }else{
            foreach ($result as $result) { ?>
                <div class="content-pd">
                <a class="a-none" href="../dealer/dealer_product_detail?p_id=<?= $result['p_id']; ?>">
                    <div class="card" id="card">
                        <div class="card-top">
                            <img src="../admin/p_img/<?= $result['p_img1'] ?>" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <p class="card-title"><?= $result['p_name'] ?></p>
                            <p class="card-text">฿<?= number_format($result['p_price1'], 2) ?></p>
                            <a href="../dealer/dealer_product_detail?p_id=<?= $result['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                        </div>
                    </div>
                </a>
                </div>
    ...
    <!-- Zone Ads -->
    <div class="ads">
        <img src="../asset/img/ads5.png" width="90%" alt="">
        <!-- <img src="../asset/img/ads4.png" width="45%" alt=""> -->
    </div>
