...
<div class="flex-shrink-0  bg-white">
    <div class="p-bg-menu" style="padding-left: 0px; padding-right: 0px;">
        <div class="p-sub-bg-menu">
            <img class="p-profile-icon" src="../asset/upload/profile_user/profile-icon.png" alt="">
            ...
            <ul class="list-unstyled ps-0">
                <li class="mb-1">
                    ...
                    <div class="collapse show" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small sidebar-flip">
                            ...
                            <li><a href="../dealer/dealer_profile_address" id="p-list-menu">
                ...
                <li class="mb-1">
                    <a href="../dealer/dealer_my_purchase"><button class="btn btn-toggle" id="p-btn-color" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                            การซื้อของฉัน
                        </button></a>
