...
if (isset($_GET['p_id'])) {
    ...
    if ($stmtPD_D->rowCount() != 1) {
        header('location: ../dealer/dealer_product');
        exit();
    }
}
        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    header("refresh:2; url=dealer_product_detail?p_id=$p_id");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($check_state == false) {
                ...
                if ($sql) {
                    ...
                    header("refresh:0.0000000001; url=dealer_product_detail?p_id=$p_id");
                }
            }
        } else {
            $sql = $conn->prepare("INSERT INTO cart(qty,price,product_id, user_id, status_cart)
        ...
        if (!empty($rowCheck)) {
            foreach ($rowCheck as $rowCheck) {
                if ($rowCheck['product_id'] == $p_id) {
                    ...
                    // })
                    // </script>";
                    header("refresh:0.0000001; url=dealer_cart");
                    if ($check_state == true) {
                        break;
                    }
                } else {
            ...
            if ($sql) {
                ...
                // </script>";
                $check_state = true;
                header("refresh:1; url=dealer_cart");
            } else {
                echo "<script>alert('มีบางอย่างผิดพลาด')</script>";
                header("refresh:0.0000000001; url=dealer_product_detail?p_id=$p_id");
            }
            ...
            <div id="navbar-menu" aria-labelledby="navbar-toggle">
                ...
                <ul class="navbar-links">
                    <div class="line-bottom">
                        <li class="navbar-item" style="padding-bottom: 5px;"><a class="navbar-link" href="../dealer/dealer_product">สินค้า</a>
                        </li>
                        ...
                        <a class="dropdown-item " href="../deale/dealer_cart"><button class="btn-register">รถเข็นสินค้า</button></a>
                        <a class="dropdown-item " href="../dealer/dealer_profile"><button class="btn-register">ข้อมูลของฉัน</button></a>
                        <a class="dropdown-item" href="../dealer/dealer_profile_bank"><button class="btn-register">บัญชีธนาคาร</button></a>
                        <a class="dropdown-item" href="../dealer/dealer_profile_password"><button class="btn-register">เปลี่ยนรหัสผ่าน</button></a>
                        <a class="dropdown-item" href="../dealer/dealer_profile_address"><button class="btn-register">ที่อยู่</button></a>
                        <a class="dropdown-item" href="../dealer/dealer_my_purchase"><button class="btn-register">การซื้อของฉัน</button></a>
                    ...
                    <div class="btnn-profile">
                        <div class="cart-icon"> <a href="../dealer/dealer_cart"><i class="bi bi-cart3"></i></a></div>
                        ...
                        <div class="profile-icon">
                            <div class="dropdown"><button type="button" id="icon-profile" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-circle" id="icon-login-profile"></i></button>
                                <ul class="dropdown-menu dropdown-menu-profile">
                                    ...
                                    <li><a class="dropdown-item " href="../dealer/dealer_profile"><i class="bi bi-person-circle" id="icon-login-profile-drop"></i>บัญชีของฉัน</a></li>
                                    <li><a class="dropdown-item" href="../dealer/dealer_my_purchase"><i class="bi bi-journal-text"></i>การซื้อของฉัน</a></li>
            ...
            <div class="g-box-related">
                ...
                foreach ($rowRT as $rowRT) { ?>
                    <div class="related-RT">
                        <a class="a-none" href="../dealer/dealer_product_detail?p_id=<?= $rowRT['p_id']; ?>">
                            <div class="card" id="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="../dealer/dealer_product_detail?p_id=<?= $rowRT['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                                </div>
                            </div>
                        </a>
                    </div>
