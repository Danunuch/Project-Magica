...
if(isset($_GET['act'])){
    $name = $_GET['search'];
    $s =  urlencode($name);
     header("refresh:0.0000000001; url=dealer_product?search=$s");
}
...
<body style="font-family: 'Kanit', sans-serif ;">
                ...
                <div class="container s-search">
                    <div class="input-group s-search">
                        ...
                        <div class="form-outline">
                            <input type="search" id="form1" name="search" required class="form-control search-bar" placeholder="ค้นหา" style="height: 45px; width: 290px; margin-left:30px; margin-top: 5px; border-radius: 5px 0px 0px 5px;box-shadow: 2px 2px 8px 4px rgba(0, 0, 0, 0.05); " />
                        </div>
    ...
    <div class="dealer-catagorie">
        <div class="item-catagorie">
            ...
            <div class="dealer-cat-box">
                <div class="bg-item">
                    <div class="item">
                        <a href="../dealer/dealer_product?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon1.png" alt="med1"></div> -->
                            <img class="cir-con" src="../asset/img/c-1.png" alt="">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product?t_id=3&name=ยาจ่ายผ่านคลินิก" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                            <img class="cir-con" src="../asset/img/c-2.png" alt="">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product?t_id=4&name=ยาที่ขึ้นทะเบียนแล้ว" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                            <img class="cir-con" src="../asset/img/c-3.png" alt="">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product?t_id=5&name=ยาแผนโบราณ" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                            <img class="cir-con" src="../asset/img/c-4.png" alt="">
                ...
                <div class="bg-item">
                    <div class="item"><a href="../dealer/dealer_product?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
                            <!-- <div class="item-bord"><img class="icon-med-hidden" src="/magica/asset/img/med-icon2.png" alt="med2"></div> -->
                            <img class="cir-con" src="../asset/img/c-5.png" alt="">
    ...
    <div class="recommence-product">
        ...
        <div class=" box-rec-pd">
            ...
            ?>
                    <div class="rec-pd">
                        <a class="a-none" href="../dealer/dealer_product_detail?p_id=<?= $product['p_id']; ?>">
                            <div class="card" id="card">
                                <div class="card-top">
                                    <img src="../admin/p_img/<?= $product['p_img1'] ?>" class="card-img-top" alt="...">
                                </div>
                                <div class="card-body">
                                    <p class="card-title"><?= $product['p_name'] ?></p>
                                    <p class="card-text">฿<?= number_format($product['p_price1'], 2)  ?></p>
                                    <a href="../dealer/dealer_product_detail?p_id=<?= $product['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="btn-see-more">
                <a href="../dealer/dealer_product"><button type="button" class="btn" id="see-more">ดูเพิ่มเติม</button></a>
            </div>
