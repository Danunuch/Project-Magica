...
if (isset($_REQUEST['delete_id'])) {
    ...
    if ($stmt) {
        echo "<script>alert('ลบผู้ใช้งานเรียบร้อยแล้ว')</script>";
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            ...
                            <tr align="center">
                                ...
                                <th width="2%">ไลน์ไอดี</th>
                                <th width="6%">ที่อยู่</th>
                                <th width="4%">สถานะ</th>
                                <th width="3%"></th>
                                <th width="3%"></th>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr style="font-size: small" ;>
                                    <td align="center"> <img src="../admin/m_img/<?php if ($row['m_img'] == null) {
                                    ...
                                    <td align="center"><?php echo $row['line_Id']; ?></td>
                                    <td><?php echo $row['address']; ?></td>
                                    <td align="center"><?php echo $row['urole']; ?></td>
                                    <td align="center" ><a href="admin_edit.php?update_id=<?php echo $row["id"]; ?>" class="btn1"><i class="bi bi-pencil-square" ></i></a></td>
