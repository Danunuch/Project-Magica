...
$page = $_GET['page'];
$select_count = $conn->prepare("SELECT * FROM product_dealer");
...
$select_stmt = $conn->prepare("SELECT * FROM product_dealer ORDER BY p_id DESC LIMIT $start,10");
$select_stmt->execute();
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_stmt = $conn->prepare('DELETE FROM product_dealer WHERE p_id = :id');
    $delete_stmt->bindParam(':id', $p_id);
    $delete_stmt->execute();

    if ($delete_stmt) {
        echo '<script>alert("ลบสินค้าชิ้นนี้เรียบร้อยแล้ว")</script>';
            ...
            <div class="col-md-12 col-sm-12 " style="height: 1024px;">
                <div class="dashboard_graph">
                    <div class="row x_title">
                        <div class="col-md-6">
                            <h3>รายการสินค้าตัวแทนจำหน่าย</h3>
                        </div> <br>
                        <div class="dashboard_graph">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr style="font-size: small" ;>
                                                ...
                                                <td align="center"><?php echo $row['p_price1']; ?>.00</td>
                                                <td align="center"><a href="product_dealer_edit.php?update_id=<?php echo $row["p_id"]; ?>" class="btn1"><i class="bi bi-pencil-square"></i></a></td>
