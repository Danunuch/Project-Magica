...
if (isset($_REQUEST['update_id'])) {
    ...
    $select_stmt = $conn->prepare("SELECT * FROM product_dealer WHERE p_id = :p_id");
    ...
    if (in_array($fileActExt1, $allow) && in_array($fileActExt2, $allow) && in_array($fileActExt3, $allow)) {
        if ($img1['size'] > 0 && $img1['error'] == 0 && $img2['size'] > 0 && $img2['error'] == 0 && $img3['size'] > 0 && $img3['error'] == 0) {
            if (move_uploaded_file($img1['tmp_name'], $filePath1) && move_uploaded_file($img2['tmp_name'], $filePath2) && move_uploaded_file($img3['tmp_name'], $filePath3)) {
                $insert_stmt = $conn->prepare("UPDATE product_dealer SET p_name = :p_name, p_detail = :p_detail, p_price1 = :p_price1 , p_price2 = :p_price2 , p_price3 = :p_price3 , 
                                                                                 p_price4 = :p_price4 , p_price5 = :p_price5, p_amount = :p_amount, p_unit = :p_unit, p_img1 = :p_img1, p_img2 = :p_img2, 
                                                                                 p_img3 = :p_img3 , t_id = :t_id WHERE p_id = :p_id");
        ...
        if ($img1['size'] > 0 && $img1['error'] == 0) {
            if (move_uploaded_file($img1['tmp_name'], $filePath1)) {
                $insert_stmt = $conn->prepare("UPDATE product_dealer SET p_name = :p_name, p_detail = :p_detail, p_price1 = :p_price1 , p_price2 = :p_price2 , p_price3 = :p_price3 , 
                                                                                 p_price4 = :p_price4 , p_price5 = :p_price5, p_amount = :p_amount, p_unit = :p_unit, p_img1 = :p_img1, 
                                                                                t_id = :t_id WHERE p_id = :p_id");
                $insert_stmt->bindParam(':p_id', $p_id);
                $insert_stmt->bindParam(':p_name', $p_name);
                $insert_stmt->bindParam(':p_detail', $p_detail);
        ...
        $insert_stmt = $conn->prepare("UPDATE product_dealer SET p_name = :p_name, p_detail = :p_detail, p_price1 = :p_price1 , p_price2 = :p_price2 , p_price3 = :p_price3 , 
        p_price4 = :p_price4 , p_price5 = :p_price5, p_amount = :p_amount, p_unit = :p_unit,
       t_id = :t_id WHERE p_id = :p_id");
        $insert_stmt->bindParam(':p_id', $p_id);
        $insert_stmt->bindParam(':p_name', $p_name);
        $insert_stmt->bindParam(':p_detail', $p_detail);
                ...
                <div class="dashboard_graph">
                    ...
                    <form method="POST" class="form-horizontal mt-5" enctype="multipart/form-data">
                        ...
                        if (isset($_GET['update_id'])) {
                            $p_id = $_GET['update_id'];
                            $stmt = $conn->prepare("SELECT * FROM product_dealer WHERE p_id = :p_id");
                            ...
                            <div class="row gx-5">
                                ...
                                <div class="col" align="left">
                                    <div class="p-3 "><label for="price1" class="col-form-label">ราคาที่ 1 สำหรับ Member</label>
                                        <input type="text" name="price1" class="form-control" value="<?php echo $row['p_price1']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gx-5">
                                <div class="col" align="left">
                                    <div class="p-3 "><label for="price2" class="col-form-label">ราคาที่ 2 สำหรับ Member</label>
                                        <input type="text" name="price2" class="form-control" value="<?php echo $row['p_price2']; ?>">
                                    </div>
                                </div>
                                <div class="col" align="left">
                                    <div class="p-3 "><label for="price3" class="col-form-label">ราคาสำหรับ VIP</label>
                                        <input type="text" name="price3" class="form-control" value="<?php echo $row['p_price3']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row gx-5">
                                <div class="col" align="left">
                                    <div class="p-3 "><label for="price4" class="col-form-label">ราคาสำหรับ Super VIP</label>
                                        <input type="text" name="price4" class="form-control" value="<?php echo $row['p_price4']; ?>">
                                    </div>
                                </div>
                                <div class="col" align="left">
                                    <div class="p-3 "><label for="price5" class="col-form-label">ราคาสำหรับ Dealer</label>
                                        <input type="text" name="price5" class="form-control" value="<?php echo $row['p_price5']; ?>">
                                    </div>
                                </div>
                            </div>
