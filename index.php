...
<div class=" catagorie">
    <div class="item-catagorie">
        ...
        <div class="dealer-cat-box">
            <div class="bg-item">
                <div class="item">
                    <a href="product?t_id=2&name=อาหารเสริม" style="text-decoration: none;">
            ...
            <!-- <div class="bg-item">
                    <div class="item"><a href="signin" style="text-decoration: none;">
            ...
            <div class="bg-item">
                <div class="item"><a href="product?t_id=1&name=ยาสามัญประจำบ้าน" style="text-decoration: none;">
...
<div class="recommence-product">
    ...
    <div class=" box-rec-pd">
        ...
        ?>
                <div class="rec-pd">
                    <a class="a-none" href="product_detail?p_id=<?= $product['p_id']; ?>">
                        <div class="card" id="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="product_detail?p_id=<?= $product['p_id']; ?>" class="btn " id="btn-dp" style="margin: 0 auto;">รายละเอียด</a>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="btn-see-more">
            <a href="product"><button type="button" class="btn" id="see-more">ดูเพิ่มเติม</button></a>
        </div>
